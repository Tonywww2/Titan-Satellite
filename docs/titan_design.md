...
| **M7 宏伟地物** | ⬜ | 乙炔大晶洞/撞击盆地/托林巨拱/悬冰大殿/主冰火山/石林迷城… | 见 §一 与 [task-plan.md](task-plan.md) Stage 7 |
| **M7 宏伟结构** | ⬜ | 深钻者/坠毁残骸/大巢/深空信标阵 | 见 §6.2 与 [task-plan.md](task-plan.md) Stage 7 |
...
2.  **托林潮汐 / 甲烷退潮 周期事件** ⬜（E5）。
3.  **M7 宏伟地物与结构** ⬜（本次新增，见 [task-plan.md](task-plan.md) Stage 7）：含新方块**乙炔冰笋 / 托林菌网**。
