...
import com.tonywww.titan_moon.block.AcetyleneSpireBlock;
import com.tonywww.titan_moon.block.CryovolcanicGeyserBlock;
import com.tonywww.titan_moon.block.HydrogenBubbleMatBlock;
import com.tonywww.titan_moon.block.HydrogenCollectorBlock;
import com.tonywww.titan_moon.block.MethaneIceBloomBlock;
import com.tonywww.titan_moon.block.MethanePoolCoreBlock;
import com.tonywww.titan_moon.block.SpecialMethanePumpBlock;
import com.tonywww.titan_moon.block.SlowingBushBlock;
import com.tonywww.titan_moon.block.TholinComposterBlock;
import com.tonywww.titan_moon.block.TholinCrystalBlock;
import com.tonywww.titan_moon.block.TholinMyceliumBlock;
...
/**
 * 方块注册表。固体方块对应的 BlockItem 在 {@link TMItems} 注册；
 * 流体方块（LiquidBlock）不注册 BlockItem，改用桶交互。
 *
 * <p>基础地形方块可用于维度 worldgen 的 default_block / surface_rule，
 * 流体方块可用于 default_fluid —— 见 data/titan_moon/worldgen/noise_settings/titan.json。
 */
public final class TMBlocks {
    ...
    public static final Supplier<LiquidBlock> LIQUID_METHANE_BLOCK = REGISTER.register("liquid_methane", () ->
            new LiquidBlock(TMFluids.LIQUID_METHANE, liquidProps(MapColor.COLOR_BROWN)));
    public static final Supplier<LiquidBlock> LIQUID_AMMONIA_BLOCK = REGISTER.register("liquid_ammonia", () ->
            new LiquidBlock(TMFluids.LIQUID_AMMONIA, liquidProps(MapColor.COLOR_LIGHT_BLUE)));
    public static final Supplier<LiquidBlock> LIQUID_HYDROGEN_BLOCK = REGISTER.register("liquid_hydrogen", () ->
            new LiquidBlock(TMFluids.LIQUID_HYDROGEN, liquidProps(MapColor.COLOR_LIGHT_BLUE)));
    //?} else {
    /*public static final Supplier<LiquidBlock> LIQUID_METHANE_BLOCK = REGISTER.register("liquid_methane", () ->
            new LiquidBlock(TMFluids.LIQUID_METHANE.get(), liquidProps(MapColor.COLOR_BROWN)));
    public static final Supplier<LiquidBlock> LIQUID_AMMONIA_BLOCK = REGISTER.register("liquid_ammonia", () ->
            new LiquidBlock(TMFluids.LIQUID_AMMONIA.get(), liquidProps(MapColor.COLOR_LIGHT_BLUE)));
    public static final Supplier<LiquidBlock> LIQUID_HYDROGEN_BLOCK = REGISTER.register("liquid_hydrogen", () ->
            new LiquidBlock(TMFluids.LIQUID_HYDROGEN.get(), liquidProps(MapColor.COLOR_LIGHT_BLUE)));
    *///?}
