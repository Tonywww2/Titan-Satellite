...
import com.tonywww.titan_moon.worldgen.density.BiomeHeightDensityFunction;
import com.tonywww.titan_moon.worldgen.feature.CryovolcanoFeature;
import com.tonywww.titan_moon.worldgen.feature.FissureFeature;
import com.tonywww.titan_moon.worldgen.feature.FrozenAmmoniaFallsFeature;
import com.tonywww.titan_moon.worldgen.feature.GiantCraterFeature;
import com.tonywww.titan_moon.worldgen.feature.HoodooLabyrinthFeature;
import com.tonywww.titan_moon.worldgen.feature.IceCathedralFeature;
import com.tonywww.titan_moon.worldgen.feature.IceSinkholeFeature;
import com.tonywww.titan_moon.worldgen.feature.ImpactBasinFeature;
import com.tonywww.titan_moon.worldgen.feature.MegayardangFeature;
import com.tonywww.titan_moon.worldgen.feature.MethaneCascadeFeature;
import com.tonywww.titan_moon.worldgen.feature.MethaneLakeFeature;
import com.tonywww.titan_moon.worldgen.feature.MethaneMareFeature;
import com.tonywww.titan_moon.worldgen.feature.SilkShroudFeature;
import com.tonywww.titan_moon.worldgen.feature.SpireFeature;
import com.tonywww.titan_moon.worldgen.feature.SpongeCaveFeature;
import com.tonywww.titan_moon.worldgen.feature.TholinArchFeature;
 ...
 * 由 {@link TMSystemsBootstrap} 在 mod 构造阶段自订阅装配到 mod 总线（不改主类）。
 *
 * <p>此处只登记 codec/类型，实际生成逻辑在各 Feature / DensityFunction 类中。
 */
public final class TMWorldgenTypes {

    private TMWorldgenTypes() {
    }

    //? if forge {
    public static final DeferredRegister<Codec<? extends DensityFunction>> DENSITY_FUNCTION_TYPES =
            DeferredRegister.create(Registries.DENSITY_FUNCTION_TYPE, TitanMoon.MODID);
    //?} else {
    ...
    *///?}
    ...
    public static final DeferredRegister<Feature<?>> FEATURES =
            DeferredRegister.create(Registries.FEATURE, TitanMoon.MODID);
    ...
    *///?}
    ...
    /** 由 {@link TMSystemsBootstrap} 在构造阶段调用，把本类的 DeferredRegister 挂到 mod 总线。 */
