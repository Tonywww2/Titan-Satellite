 ...
 * 不改主类，与 {@code TMSystemsBootstrap} 同模式。
 *
...
//?}
public final class TMStructures {

    private TMStructures() {
    }

    public static final DeferredRegister<StructureType<?>> STRUCTURE_TYPES =
            DeferredRegister.create(Registries.STRUCTURE_TYPE, TitanMoon.MODID);
    public static final DeferredRegister<StructurePieceType> PIECE_TYPES =
            DeferredRegister.create(Registries.STRUCTURE_PIECE, TitanMoon.MODID);

    public static final Supplier<StructureType<TitanStructure>> TITAN_STRUCTURE =
            STRUCTURE_TYPES.register("titan_structure", TMStructures::titanStructureType);
