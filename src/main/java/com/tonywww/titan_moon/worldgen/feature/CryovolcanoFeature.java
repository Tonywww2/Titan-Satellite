...
public class CryovolcanoFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        BlockState ice = TMBlocks.CRYO_ICE.get().defaultBlockState();
        BlockState air = Blocks.CAVE_AIR.defaultBlockState();
        BlockState ammonia = TMBlocks.LIQUID_AMMONIA_BLOCK.get().defaultBlockState();
        BlockState geyser = TMBlocks.CRYOVOLCANIC_GEYSER.get().defaultBlockState();
