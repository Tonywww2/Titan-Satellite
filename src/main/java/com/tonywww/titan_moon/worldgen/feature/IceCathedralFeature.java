...
public class IceCathedralFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        BlockState accent = TMBlocks.PACKED_METHANE_ICE.get().defaultBlockState();
        BlockState air = Blocks.CAVE_AIR.defaultBlockState();
        BlockState methane = TMBlocks.LIQUID_METHANE_BLOCK.get().defaultBlockState();
        BlockState bloom = TMBlocks.METHANE_ICE_BLOOM.get().defaultBlockState();
