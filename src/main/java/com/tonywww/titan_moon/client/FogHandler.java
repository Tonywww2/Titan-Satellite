...
import com.tonywww.titan_moon.registry.TMDimensions;
 ...
 */
//? if forge {
@Mod.EventBusSubscriber(modid = TitanMoon.MODID, value = Dist.CLIENT)
//?} else {
...
public final class FogHandler {
    ...
    private static final ResourceLocation METHANE_ABYSS = TitanMoon.rl("methane_abyss");
    ...
    private static boolean isTitan(Camera camera) {
        ...
        return entity != null && entity.level().dimension() == TMDimensions.TITAN_LEVEL;
    }
