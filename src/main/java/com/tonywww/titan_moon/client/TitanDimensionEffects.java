 ...
 * （客户端 <b>Mod 总线</b>）注册到 {@code titan_moon:titan}——须与
 * {@code data/titan_moon/dimension_type/titan.json} 的 {@code "effects"} 字段一致。
 *
...
public class TitanDimensionEffects extends DimensionSpecialEffects {
    ...
    public static final ResourceLocation KEY = TitanMoon.rl("titan");
